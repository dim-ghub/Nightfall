...
# =============================================================================
# SpiceText Setup Script
# =============================================================================
# This script manages the Spicetify text theme with matugen color scheme
# =============================================================================
...
apply_theme() {
	...
	log_success "Spicetify text theme with matugen colors configured!"
}
...
# Action handlers
handle_uninstall() {
	log_info "Uninstalling SpiceText theme..."
	complete_reset
	log_success "SpiceText theme uninstalled!"
}

handle_on() {
	log_info "Enabling SpiceText theme..."
	apply_theme
}

handle_off() {
	log_info "Disabling SpiceText theme..."
	reset_theme
}

handle_install() {
	log_info "Installing SpiceText theme..."
	apply_theme
}
